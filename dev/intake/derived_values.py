...
def load_catalogue(path=CATALOGUE_PATH):
    ...
    by_input, rule_ids = {}, set()
    for rule in data["rules"]:
        expected = {"rule_id", "catalogue_version", "valuation_type", "input_item_ids",
    ...
    return {"catalogue_version": data["catalogue_version"], "rules": data["rules"], "by_input": by_input}
